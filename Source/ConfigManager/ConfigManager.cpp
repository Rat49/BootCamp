...
const std::vector<std::pair<const std::string, const std::string>> LogCategory::GetValues(const std::string& keyValue) const {

	auto range = params.equal_range(keyValue);
